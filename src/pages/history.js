...
function HistoryBar({ data }) {
  ...
  return (
    <div className="table-container">
      ...
      {data.map((item, index) => (
        <div className="mobile-disp-db">
          <div
            className={`mobile-disp-newUrl ${active ? 'active' : ''}`}
            onClick={() => handleSetIndex(index)}>
            {item.newUrl}
          </div>
          <div className="mobile-disp-list">
            <span className="mobile-disp-list-sp-el">
              <h3 className="mobile-disp-list-h3-el">Original Url</h3>
              <p className="mobile-disp-list-h3-el">{item.originalUrl}</p>
            </span>
            <span className="mobile-disp-list-sp-el">
